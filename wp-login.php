...
<html lang="en-US">
	...
	<title>Log In &lsaquo; Programa Kairós &#8212; WordPress</title>
...
<meta name="theme-color" content="#ffffff">	<meta name="referrer" content="strict-origin-when-cross-origin">
	...
	<script type="text/javascript">document.body.className = document.body.className.replace('no-js','js');</script>
		...
		<form name="loginform" id="loginform" action="http://programakairos.com/wp-login.php" method="post">
			<p>
			...
			<p class="submit">
				<input type="submit" name="wp-submit" id="wp-submit" class="button button-primary button-large" value="Log In">
									<input type="hidden" name="redirect_to" value="http://programakairos.com/wp-admin/">
...
if ( typeof wpOnload === 'function' ) { wpOnload() }</script>
				<p id="backtoblog">
			<a href="/">&larr; Go to Programa Kairós</a>		</p>
		<div class="privacy-policy-page-link"><a class="privacy-policy-link" href="/politica-privacidade/">Politica de Privacidade</a></div>	</div>
			<script src="/wp-includes/js/jquery/jquery.min.js?ver=3.6.1" id="jquery-core-js"></script>
<script src="/wp-includes/js/jquery/jquery-migrate.min.js?ver=3.3.2" id="jquery-migrate-js"></script>
<script id="zxcvbn-async-js-extra">var _zxcvbnSettings = {"src":"http:\/\/programakairos.com\/wp-includes\/js\/zxcvbn.min.js"};</script>
...
<script id="user-profile-js-extra">var userProfileL10n = {"user_id":"0","nonce":"8cc1a7928a"};</script>
